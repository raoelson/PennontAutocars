...
public class EncoursFragment extends Fragment {
    ...
    public static EncoursFragment newInstance() {
        EncoursFragment fragment = new EncoursFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.encours_fragment, container, false);

        resquestPackage = new ResquestPackage();
        httpManager = new HttpManager(mcontext);
        preferences =  PreferenceManager.getDefaultSharedPreferences(getActivity());
        mVide = (TextView) rootView.findViewById(R.id.text_vide);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(preferences.getString("ipserver","")!=null){
            if(httpManager.isOnline()){
                String url =httpManager.URL_serveur()+""+preferences.getString("ipserver","")+"mission/listes_missions";
                RequestData(url);
            }else{
    ...
    public void displayData(String param){
        if(param!=null){
            ...
            EncoursAdapter adapter = new EncoursAdapter(getContext(), parseJSONMembre.getAllMission(param),
                    parseJSONMembre.testMission(param));
            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
            mRecyclerView.setLayoutManager(layoutManager);
            if(parseJSONMembre.getAllMission(param).isEmpty()){
                mVide.setVisibility(View.VISIBLE);
                mVide.setText("Il n\'y a pas de mission en cours");
            }else{
