 ...
 */
public class MissionAncienneFragment extends Fragment {

    private SpeedyQuickReturnRecyclerViewOnScrollListener mScrollListener;
    @Bind(R.id.rv_ancienne)
    ...
    public static MissionAncienneFragment newInstance(){
        MissionAncienneFragment mFragment = new MissionAncienneFragment();
        return mFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.ancienne_fragment, container, false);
        ...
        mVide = (TextView) rootView.findViewById(R.id.text_vide_ancienne);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if(preferences.getString("ipserver","")!=null){
            if(httpManager.isOnline()){
                String url =httpManager.URL_serveur()+""+preferences.getString("ipserver","")+"mission/listes_missionsAncienne";
                RequestData(url);
            }else{
    ...
    public void displayData(String param){
        if(param!=null){
            ...
            MissionAncienneAdapter adapter = new MissionAncienneAdapter(getContext(), parseJSONMembre.getAllMission(param));
            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(getActivity());
            mRecyclerView.setLayoutManager(layoutManager);
            if(parseJSONMembre.getAllMission(param).isEmpty()){
                mVide.setVisibility(View.VISIBLE);
                mVide.setText("Il n\'y a pas de mission ancienne");
            }else{
