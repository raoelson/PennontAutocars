package soluces.com.library.liveo.Model;
...
public class HelpLiveo {
    ...
    public void addNoCheck(String name, String icon){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setCheck(false);
    ...
    public void addHide(String name, String icon){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setHide(IS_HIDE);
    ...
    public void addHideNoCheck(String name, String icon){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setHide(IS_HIDE);
    ...
    public void add(String name, String icon, int counter){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setCheck(IS_CHECK);
    ...
    public void addNoCheck(String name, String icon, int counter){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setCheck(false);
    ...
    public void addHide(String name, String icon, int counter){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setCounter(counter);
    ...
    public void addHideNoCheck(String name, String icon, int counter){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setCounter(counter);
    ...
    public void addSubHeader(String name,String icon){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
    ...
    public void addSubHeaderHide(String name, String icon){
        this.newHelpItem();
        this.helpItem.setName(name);
        this.helpItem.setIcon(icon);
        this.helpItem.setHeader(IS_HEADER);
