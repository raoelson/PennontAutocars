...
package soluces.com.library.liveo.adapter;
...
public class NavigationLiveoAdapter extends BaseAdapter {
    ...
    public NavigationLiveoAdapter(Context context, List<NavigationLiveoItemAdapter> list, List<Boolean> extraRemove, List<Integer> extra) {
        ...
        this.font_icon = Typeface.createFromAsset(mcontext.getAssets(),"fonts/fontawesome-webfont.ttf");
    }
    @Override
    public int getCount() {
        return mList.size();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.icon.setTypeface(font_icon);
